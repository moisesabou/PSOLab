...
if _%COMPUTERNAME%_==_DESKTOP-N1CCIKO_ goto config_DESKTOP-N1CCIKO
...
:config_DESKTOP-N1CCIKO

SET VOL_MOUNT_LETTER="Q:"
SET PATH_TO_VM_TOOLS="C:\Program Files (x86)\VMware\VMware Virtual Disk Development Kit"
SET PATH_TO_LOG_FILE="D:\PSO\HAL9000\VM\HAL9000_VM\HAL9000.log"
SET PATH_TO_VIX_TOOLS="C:\Program Files (x86)\VMware\VMware Workstation"
SET PATH_TO_VM_FILE="D:\PSO\HAL9000\VM\HAL9000_VM\HAL9000.vmx"
SET PXE_PATH="D:\PSO\HAL9000\PXE"
SET PATH_TO_VM_DISK="D:\PSO\HAL9000\VM\HAL9000_VM\HAL9000.vmdk"
goto end
